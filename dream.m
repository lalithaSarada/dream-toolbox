...
% 
% If you haven't used the dream-UA documentation before, you need to 
% install it by running >> dream -docinstall
% <a href="matlab:dream -docinstall">Install documentation now</a>
% 
%
% revision of DREAM algorithm by J.A. Vrugt
%
    ...
    switch varargin{1}
        case '-docinstall'
            try
                try
                    ...
                    if dreamPar.verboseOutput
                        disp(['DREAM: ',char(39),'info.xml',char(39),' file ',...
                ...
                try
                    ...
                    if dreamPar.verboseOutput
                        disp(['DREAM: ',char(39),'dream_styles.css',char(39),' has been updated successfully.'])
                    end
        ...
        case '-addtools'
            try
                ...
                if dreamPar.verboseOutput
                    disp('DREAM: tools should now be available.')
                end
    ...
    while continueDream(dreamPar,nModelEvals)
            ...
            for iOffspring = 1:dreamPar.nOffspringPerSeq
                ...
                if dreamPar.delayedRejection && numel(rejectedSeqIdx) > 0
                    ...
                    [propChildDelayed,nModelEvals] = calcobjscore(dreamPar,propChildDelayed(rejectedSeqIdx,:),nModelEvals, iteration);
        ...
        if (iteration*dreamPar.nSeq <= 0.1 * dreamPar.nModelEvalsMax)
            if dreamPar.crossoverValuesTuning
                [pCrossover,crossoverCount] = updateCrossoverValues(dreamPar,allCrossoverValues,deltaTot,crossoverCount); 
            end;
        else
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %    
% % % % % %                                             % % % % % %    
% % % % % %     DREAM LOCAL FUNCTIONS START HERE      % % % % % %    
% % % % % %                                             % % % % % %    
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %    
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %    
...
disp([10,...
      '% This is a pre-alpha release of the DREAM ',10,...
